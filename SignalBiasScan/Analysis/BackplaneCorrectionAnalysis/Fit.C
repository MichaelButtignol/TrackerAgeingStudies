...
void FitOneCurve(string subdet, string run, ULong64_t modid, int debug=0)
{
  ...
  if(!g) {cout<<"Error: Problem with GetClusterWidthGraph at line " << __LINE__ << endl; return ;}

  // Correct for voltage drop due to leakage current
  string corr_name=subdet+"_"+run;
  
  if(subdet == "TOB") modid /= 10;  // Because correction only exists for the whole module (the two sensors of the same module are so assumed to have the same correcion)
...
void FitTOBCurves(string run)
{
  FitOneCurve("TOB", run, 4362815081, 1);
  FitOneCurve("TOB", run, 4362815082, 1);
  FitOneCurve("TOB", run, 4362815121, 1);
  FitOneCurve("TOB", run, 4362815122, 1);
  FitOneCurve("TOB", run, 4362815161, 1);
  FitOneCurve("TOB", run, 4362815162, 1);
  FitOneCurve("TOB", run, 4362815201, 1);
  FitOneCurve("TOB", run, 4362815202, 1);
  FitOneCurve("TOB", run, 4362815241, 1);
  FitOneCurve("TOB", run, 4362815242, 1);
  FitOneCurve("TOB", run, 4362815281, 1);
  FitOneCurve("TOB", run, 4362815282, 1);  
...
void Fit()
{
  ...
  FitTOBCurves("20110315_run160497");
  FitTOBCurves("20120812_run200786");
  FitTOBCurves("20120928_run203832");
  FitTOBCurves("20121130_run208339");
}
