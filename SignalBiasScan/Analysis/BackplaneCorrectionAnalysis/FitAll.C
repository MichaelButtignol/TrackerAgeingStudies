...
void FitAll(string SubDet, string Run)
{
  int err_type=0;
  const int step = 55;
...
int main(int argc, char *argv[]) {
  ...
  FitAll("TOB", "_20110315_run160497");
  FitAll("TOB", "_20120812_run200786");
  FitAll("TOB", "_20120928_run203832");
  FitAll("TOB", "_20121130_run208339");
  return 0;
}
